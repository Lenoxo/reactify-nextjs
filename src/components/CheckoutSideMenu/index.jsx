...
function CheckoutSideMenu() {
    ...
    return (
        ...
        <aside // Dependiendo del valor de isCheckoutSideMenuOpen, se muestra/oculta CheckoutSideMenu.
            className={`${context.isCheckoutSideMenuOpen ? 'flex' : 'hidden'} flex flex-col fixed z-20 right-0 top-0 w-screen h-full overflow-y-auto md:top-[60px] md:w-[360px] bg-white dark:bg-zinc-800 dark:text-white border border-inherit rounded-lg md:h-[calc(100vh-60px)]`}>
